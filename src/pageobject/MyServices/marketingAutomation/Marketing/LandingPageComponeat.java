...
public class LandingPageComponeat {
	public static	XmlReader readData;
	public static DataSheet datssheet;
	public LandingPageComponeat(String filename,String className) throws Exception {
		  UTF.callLog4j(className);
		  readData=new XmlReader(filename);
	      }
	public LandingPageComponeat(String xmlfilename,String className,String excelFile) throws Exception {
		  UTF.callLog4j(className);
		  readData=new XmlReader(xmlfilename);
		  datssheet=new DataSheet(excelFile);
		  }
	public LandingPageComponeat(String className) throws Exception {
		  UTF.callLog4j(className);
	      }
    ...
    public void LandingPages(){
	      UTF.clickelement("xpath", "//*[text()='Landing Pages']");
	   if(UTF.findElement("xpath", "//*[@class='smarttable-head']").getText().equals("Landing Pages")) {
    ...
    public void LandingPagesTemplatefeatures(String datasheetname) throws Exception {
      ...
      public void emialTemplate_View(String LandingPageName) {
